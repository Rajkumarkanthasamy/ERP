-- ============================================================
-- PHASE 3: Comments, Attachments, GRN tracking
-- Idempotent script for ERP_Database
-- ============================================================

PRINT 'Phase 3 schema alignment starting...';
GO
...
BEGIN
    ...
    (
        ...
        EntityType    NVARCHAR(20) NOT NULL,   -- PR / PO / GRN
        EntityRef     NVARCHAR(64) NOT NULL,   -- PRNumber or PO ID
...
BEGIN
    ...
    (
        ...
        PORef         NVARCHAR(64) NULL,       -- PR/PO reference (DBOMNo)
...
BEGIN
    ...
    CREATE INDEX IX_GRND_Item ON ProcurementGRNDetail(ItemCode);
END
GO
